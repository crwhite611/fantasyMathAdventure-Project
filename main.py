...
playerCharacter = namedtuple('playerCharacter',['race', 'health ', 'critTime']) # Creates "mould" for character object; allows us to map characteristics to character name
...
# \/ Creates objects for each character \/ 
    ...
    samson = playerCharacter('Hobbit', '10','7')
    rog = playerCharacter('Orc','12','6')
