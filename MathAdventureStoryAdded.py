...
# \/ Part 1/3, City \/
    ...
    print("Recently, rumors that the infamous Black Dagger Gang had been abducting people were circulating through the city.\n")
    time.sleep(4)
...
# \/ Check if second answer was correct \/
 ...
 # \/ First post-combat text, only display this + following if player wins battle(?) \/
...
# \/ Second post-combat text, only display this + following if player wins battle(?) \/
